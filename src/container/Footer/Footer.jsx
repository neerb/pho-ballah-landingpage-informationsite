  ...
  <div className="app__footer section__padding" id="footer">
    ...
    <div className="app__footer-links">
      ...
      <div className="app__footer-links_logo">
        ...
        <p className="p__opensans">"The best way to find the yummy, is to simply ask your tummy." -Chef Yummy Tummy</p>
    ...
    <div className="footer__copyright">
      <p className="p__opensans">2023 PHO-BALLAH. All Rights reserved.</p>
    </div>
  </div>
);
